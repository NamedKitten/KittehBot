...
namespace utils {
 ...
 void split( const std::basic_string<CharType>& string,
             CharType deliminator,
             OutputIt result ) {
 ...
 template <typename CharType,
           typename Container = std::vector<std::basic_string<CharType>>>
 ...
 std::basic_string<CharType> join( InputIt begin,
                                   InputIt end,
                                   const DeliminatorType& deliminator ) {
 ...
 template <typename CharType>
 std::basic_string<CharType>& remove_leading_whitespace(
  ...
  while ( leading_space_it != input.end() && isspace( *leading_space_it ) )
   ++leading_space_it;
 ...
 template <typename CharType>
 std::basic_string<CharType>& remove_trailing_whitespace(
     std::basic_string<CharType>& input ) {
  if ( input.empty() ) return input;
  ...
  typename std::basic_string<CharType>::reverse_iterator trailing_space_it =
      input.rbegin();
  while ( trailing_space_it != input.rend() && isspace( *trailing_space_it ) )
   ++trailing_space_it;
 ...
 template <typename CharType>
 std::basic_string<CharType> without_leading_whitespace(
     std::basic_string<CharType> input ) {
 ...
 template <typename CharType>
 std::basic_string<CharType> without_trailing_whitespace(
     std::basic_string<CharType> input ) {
